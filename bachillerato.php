<?php
/**
 * bachillerato.php - Página independiente para Bachillerato PAE
 */
...
// Filtrar por grados de Bachillerato: ajustar aquí si tus nombres son distintos
$grade_patterns = [
	"%bachillerato%",
	"%sexto%",
	"%septimo%",
...
// Totales: contar solo estudiantes que pertenecen a grados de Bachillerato
...
if (tableExists($conexion, 'acceso_pae')) {
	...
	// Contar accesos solo de estudiantes de bachillerato
	...
	$fecha_esc = $conexion->real_escape_string($fecha);
	// Fallback: contar entregas asociadas a estudiantes de bachillerato (si la tabla entrega tiene id_estudiante)
...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
	<div class="container">
		<a class="navbar-brand fw-bold" href="#">PAE - Bachillerato</a>
		<div class="d-flex">
			<a class="btn btn-outline-secondary btn-sm me-2" href="index.html">Volver</a>
			<a class="btn btn-primary btn-sm me-2" href="list_estudiantes.php?nivel=bachillerato">Lista de estudiantes</a>
			<a class="btn btn-success btn-sm" href="add_estudiante.php?nivel=bachillerato">Registrar</a>
		</div>
	</div>
</nav>
...
<main class="container py-4">
	<div class="row align-items-center top-bar mb-4">
		<div class="col-md-8">
			<h1 class="h3 mb-0">Bachillerato PAE</h1>
			<div class="small-muted">Reporte de alimentación - Bachillerato</div>
		</div>
